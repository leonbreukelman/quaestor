# AGENTS.md: Guidance for AI Agents in quaestor

This file provides actionable instructions for AI coding agents working in the **quaestor** repository. User prompts override all contents. Nearest AGENTS.md takes precedence in subdirectories.
